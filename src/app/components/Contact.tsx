...
const Contact = () => {
    ...
    const email = "kartikmalikdevofficial@gmail.com"
    ...
    return (
        <section id="contact" className="section" style={{ paddingBlock: "5rem" }}>
            <div className=" flex justify-center gap-6 text-5xl md:text-6xl w-full mb-6">
                <h3 className=" text-whitetext font-[900] mx-auto">
                    Contact<span className="text-lightgreen">.</span>
                </h3>
            </div>
                    ...
                    <BoxReveal boxColor={boxRevelColor} duration={0.5}>
                        <p className="mb-6 mx-auto max-w-[50%] text-[19px] font-extralight text-whitetext">
                            ...
                            <a target="_blank" href={getLinkUrl("linkedin")}>
                                <span className="text-lightgreen">Linkedin</span>
                            </a>{" "}
                            or{" "}
                            <a target="_blank" href={getLinkUrl("github")}>
                                <span className="text-lightgreen">Github</span>
                            </a>{" "}
