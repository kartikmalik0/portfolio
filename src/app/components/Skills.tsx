...
import SkillsSuspense from "./suspenses/SkillsSuspense";
...
const Skills = () => {
    ...
    // -------------------------
    const skills: Skill[] = [
        { id: "1", skillName: "Next.js", skillType: "work" },
        { id: "2", skillName: "React.js", skillType: "work" },
        { id: "3", skillName: "Node.js", skillType: "work" },
        { id: "4", skillName: "Prisma", skillType: "work" },
        { id: "5", skillName: "PostgreSQL", skillType: "work" },
        { id: "6", skillName: "Docker", skillType: "work" },
        { id: "7", skillName: "Drizzle", skillType: "work" },
        { id: "8", skillName: "Neon", skillType: "work" },
        { id: "9", skillName: "Supabase", skillType: "work" },
        { id: "10", skillName: "Clerk", skillType: "work" },
        { id: "11", skillName: "Redis", skillType: "work" },
        { id: "12", skillName: "Angular", skillType: "work" },
        { id: "13", skillName: "Hono", skillType: "work" },

        { id: "14", skillName: "AI Tools", skillType: "fun" },
        { id: "15", skillName: "GoLang", skillType: "fun" },
        { id: "16", skillName: "Framer Motion", skillType: "fun" },
        { id: "17", skillName: "Cloudflare Workers", skillType: "fun" },
        { id: "18", skillName: "Rust", skillType: "fun" },
        { id: "19", skillName: "Telegram Bots", skillType: "fun" },
        { id: "20", skillName: "Shopify", skillType: "fun" },
    ];
                    ...
                    <div className="flex flex-wrap gap-4 mb-6">
                        {skills.map((skill) =>
                            skill.skillType === "work" && (
                                <span
                                    key={skill.id}
                                    className="bg-lightblack px-2 py-1 rounded-md text-whitetext"
                                >
                                    {skill.skillName}
                                </span>
                            )
