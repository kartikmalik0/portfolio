        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_300px] gap-7 ">
          <div>
            <div className="  relative overflow-hidden">
              {data?.about ?
                data?.about.map((about: { id: Key | null | undefined; description1: boolean | ReactChild | ReactFragment | ReactPortal | null | undefined; description2: boolean | ReactChild | ReactFragment | ReactPortal | null | undefined; description3: boolean | ReactChild | ReactFragment | ReactPortal | null | undefined }) => (
                  <div key={about.id}>
                    <BoxReveal boxColor={boxRevelColor} duration={0.5}>
