"use client"
import { fetchAbout } from "@/actions/fetch-data"
            ...
            {data?.about && data?.about.map((about) => (
              <>
                <p className=" mb-6 font-extralight text-whitetext">
                  {about.description1}
                </p><p key={about.description2} className=" mb-6 font-extralight text-whitetext">
                  {about.description2}
                </p><p className=" mb-6 font-extralight text-whitetext">
                  {about.description3}
                </p>
              </>
            ))}
